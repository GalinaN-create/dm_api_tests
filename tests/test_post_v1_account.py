...
from hamcrest import assert_that, has_properties, starts_with, instance_of
...
def test_post_v1_account():
    ...
    assert_that(response.resource.login, starts_with("admin400"))
    assert_that(response.resource.rating.enabled, instance_of(bool))
